...
var enableProfiler = require('../lib/enable_profiler/EnableProfiler');
// console.log("This is from users.js", enableProfiler);
class Users extends Controller{
    ...
    index(req, res){
        ...
        let profiler_data = req.profiler;
        res.render('index', {msg, profiler_data});
        req.session.destroy();
    }
    async login(req, res){
